...
static void test_canonical_id_known_vectors(void) {
    ...
    const uint8_t expected_tracker[16] = {
        0x04, 0x28, 0x3c, 0x08, 0xfe, 0x9f, 0x73, 0x55,
        0x66, 0x89, 0x8b, 0x69, 0x82, 0xea, 0xc6, 0xc7,
    };
    ...
    const uint8_t expected_binary_tracker[16] = {
        0xd7, 0xf1, 0x18, 0xff, 0xa4, 0xee, 0xbc, 0x99,
        0xfd, 0xfe, 0x8b, 0x22, 0x1f, 0x37, 0xa1, 0xf2,
    };
    assert(memcmp(
        id,
